...
![Adressen](https://img.shields.io/badge/adressen-9.281.780-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-19--06--2021-brightgreen)
...
- adressen.7z (707.0MB uitgepakt): dit archief bevat een CSV bestand met daarin van alle adressen de volgende
  gegevens:
  - Straatnaam
  - Huisnummer
  - Postcode
  ...
  - Latitude
  - Longitude
- provincies.7z (707.0MB uitgepakt): dit archief bevat CSV bestanden van alle adressen, gesplitst per
  provincie.
