...
![Adressen](https://img.shields.io/badge/adressen-9.271.276-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-24--04--2021-brightgreen)
...
- adressen.7z (706.2MB uitgepakt): dit archief bevat een CSV bestand met daarin van alle adressen de volgende
  gegevens:
  - Straatnaam
  - Huisnummer
  - Postcode
  ...
  - Latitude
  - Longitude
- provincies.7z (706.2MB uitgepakt): dit archief bevat CSV bestanden van alle adressen, gesplitst per
  provincie.
