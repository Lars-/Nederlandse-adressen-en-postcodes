...
![Adressen](https://img.shields.io/badge/adressen-9.263.530-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-03--04--2021-brightgreen)
...
- adressen.7z (705.6MB uitgepakt): dit archief bevat een CSV bestand met daarin van alle adressen de volgende
  gegevens:
  - Straatnaam
  - Huisnummer
  - Postcode
  ...
  - Latitude
  - Longitude
- provincies.7z (705.6MB uitgepakt): dit archief bevat CSV bestanden van alle adressen, gesplitst per
  provincie.
